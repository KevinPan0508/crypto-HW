...
def play():
    ...
    for contribution in contributions:
        print(f"Commitment: {MD5(contribution)}")
    new_commitment = input("Give me your commitment (MD5(b'CNS'+contribution+b'hw3')) in hexadecimal: ")
    ...
    if MD5(new_contribution) != new_commitment:
        print("You cheat me!!! You lose in this turn!")
        return False
